...
INSERT INTO dogs 
  ...
  ('Bailey', 'poodle', 'female', 2, 'medium', false, true, '{"small": true, "medium": true, "large": true}', '{"male": true, "female": true}', '{"pitbull": true}', 'Smart and happy dog, enjoys playing with everyone', './public/bailey.jpeg', 2),
  ...
  ('Abby', 'bulldog', 'female', 4, 'medium', true, true, '{"medium": true}', '{"female": true}', '{"pitbull": true}', 'Give Abby a treat, and she will become your best friend', './public/abby.jpeg', 5),

  ('Jackson', 'german shepherd', 'male', 7, 'large', true, true, '{"small": true, "medium": true}', '{"male": true, "female": true}', '{}', 'As a resque dog, Jackson is a bit careful towards other dogs at first, but given a little time, he becomes best friends with everybody', './public/jackson.jpeg', 6),
  ...
  ('Percy', 'boxer', 'male', 5, 'large', false, true, '{"small": true, "medium": true, "large": true}', '{"male": true}', '{}', 'Large dog who thinks he is a puppy, Percy loves long walks and rubs on his back', './public/percy.jpeg', 8),

  ('Daisy', 'pitbull', 'female', 2, 'medium', true, false, '{"small": true, "medium": true}', '{"female": true}', '{}', 'Resque dog, quite careful around other dogs and people, just give her a treat and she will become best friends with you', './public/daisy.jpeg', 9),
  ...
  love to go on a walk with you.', './public/happy_baby.jpeg', 12)